...
\centering
\subfigure[]{
    \includegraphics[width=0.15\columnwidth, keepaspectratio]{code_week2/f1}
\label{fig:f1}
}
\subfigure[]{
    \includegraphics[width=0.15\columnwidth, keepaspectratio]{code_week2/f2}
    \label{fig:f2}
}
\subfigure[]{
    \includegraphics[width=0.15\columnwidth, keepaspectratio]{code_week2/f3}
    \label{fig:f3}
}
\subfigure[]{
    \includegraphics[width=0.15\columnwidth, keepaspectratio]{code_week2/f4}
    \label{fig:f4}
}
\subfigure[]{
    \includegraphics[width=0.15\columnwidth, keepaspectratio]{code_week2/f5}
    \label{fig:f5}
}
